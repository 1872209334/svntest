...
public class AliyunOSSConfigConstant {
    ...
    //仓库名称
    public static final String BUCKE_NAME = "lys-arc";
    //地域节点
    public static final String END_POINT = "oss-cn-hangzhou.aliyuncs.com" ;
    //AccessKey ID
    public static final String AccessKey_ID = "LTAIbkqHJeOO2D19";
    //Access Key Secret
    public static final String AccessKey_Secret = "l2IaYB5NRHo9tZwfxqIbHsfmnqliSQ";
    //仓库中的某个文件夹
    public static final String FILE_HOST = "img";
    //仓库中的企业文件夹
    public static final String COMPANY_FLODER_KEY = "company";
}
