 ...
 */ 
@Configuration 
@MapperScan(basePackages= "com.qf.mapper.admin",sqlSessionFactoryRef="adminSqlSessionTemplate") 
public class AdminMyBatisConfig { 
	...
	public SqlSessionFactory adminSqlSessionFactory(DynamicDataSource ds) { 
        SqlSessionFactoryBean bean = new SqlSessionFactoryBean();
        bean.setDataSource(ds);
        bean.setTypeAliasesPackage("com.qf.model.admin");
        //添加XML目录
	...
	@Bean(name="adminSqlSessionTemplate") 
	public SqlSessionTemplate adminSqlSessionTemplate(@Qualifier("adminSqlSessionTemplate") SqlSessionFactory sqlSessionFactory) { 
