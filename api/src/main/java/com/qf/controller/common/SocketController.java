...
public class SocketController {
	...
	@RequestMapping(value = "/sendSocketMessage", method = RequestMethod.POST)
	...
	public ModelMap sendSocketMessageForStringtoHex(HttpServletRequest request) throws IOException {
    	...
    	String deviceCode = request.getParameter("deviceCode");
    	String extraData = request.getParameter("extraData");
    	String hexExtraData = ToolUtil.hexStr2Str(extraData);
...
//				}
    	...
    	String directive = messageHeader + siteCode + deviceCode + "0000" + messageFix + commandMark + responseMark + pdu;
    	...
    	String messageStr = "7E" + messageHeader + siteCode + deviceCode + "0000" + messageFix + commandMark + responseMark + pdu + crcData + "7E";
