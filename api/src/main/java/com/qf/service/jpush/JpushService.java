...
public class JpushService { 
     ...
     * 
     */ 
	public void sendPush(String title, String content, Map<String, String> extrasMap, String... alias) { 
		...
		// 使用NativeHttpClient网络客户端，连接网络的方式，不提供回调函数 
			...
			PushResult result = null; 
			try { result = jpushClient.sendPush(payload); 
	...
	public void sendPushWithCallback(String title, String content, Map<String, String> extrasMap, String... alias) { 
		...
		NettyHttpClient client = new NettyHttpClient( ServiceHelper.getBasicAuthorization(appkey, secret), null, clientConfig); 
		try { 
